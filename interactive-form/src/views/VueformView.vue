      ...
      schema: {
        ...
        ex_partners: {
          ...
          element: {
                ...
                element: {
                  ...
                  schema: {
                    ...
                    start_primary: {
                      ...
                      loadFormat: "YYYY-MM-DD",
                      placeholder: "23.01.2000",
                      rules: ["required", "after:ex_partners.*.children.*.date_of_birth"],
                    },
                    start_secondary: {
                      type: "date",
                      ...
                      loadFormat: "YYYY-MM-DD",
                      placeholder: "23.01.2000",
                      rules: ["required", "after:ex_partners.*.children.*.start_primary"],
                    },
                  },
                  label: "Kind",
                },
            ...
            label: "Unterhaltspflichtige Person",
          },
          addText: "+ Hinzufügen",
          min: 1,
        },
        ...
        submit: {
          type: "button",
          submits: true,
          buttonLabel: "Berechnung starten",
          full: true,
          size: "lg",
        },
      },
